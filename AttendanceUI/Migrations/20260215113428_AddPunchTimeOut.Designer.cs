...
namespace AttendanceUI.Migrations
{
    ...
    [Migration("20260215113428_AddPunchTimeOut")]
    partial class AddPunchTimeOut
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttendanceUI.Models.DailyAttendance", b =>
                {
                    ...
                    b.Property<string>("ManualOverrideBy")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)")
                        .HasColumnName("manual_override_by");
            ...
            modelBuilder.Entity("AttendanceUI.Models.Employee", b =>
                {
                    ...
                    b.Property<bool>("IsPunchExempt")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("is_punch_exempt");
